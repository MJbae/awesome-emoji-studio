...
Each edition has a compact seven-stage diagram, three points explaining the design, and a collapsed interface preview. Local execution instructions and developer-guide links have been removed from all five overview pages. Details about stage inputs, outputs, and implementation live in the [pipeline design](../pipeline.md) and [developer guide](../development.md).
...
- Relative links, language navigation, and author attribution were checked. All five overview pages were checked for remaining local execution instructions.
